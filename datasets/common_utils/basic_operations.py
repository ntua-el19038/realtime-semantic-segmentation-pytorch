...
sys.path.append('../')
from .dataset_utils import resample_by_spacing, normalize_minmax_data
...
def construct_input(segmentation, image=None, num_classes=None, apply_softmax=True, temperature=2, is_labelmap=False,
                    smooth_label=False, shuffle=False, use_gpu=True):
    """
...
def load_img_label_from_path(img_path, label_path=None, new_spacing=None, normalize=False, keep_z_spacing=True,
                             z_score=False):
    '''
