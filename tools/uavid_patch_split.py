...
def image_augment(image,mode='train'):
    image_list = []
    mask_list = []
...
def padifneeded(image):
    pad = albu.PadIfNeeded(min_height=2160, min_width=4096, position='bottom_right',
                           border_mode=0, value=[0, 0, 0], mask_value=[255, 255, 255])(image=image)
